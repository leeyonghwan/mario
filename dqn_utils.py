...
class ReplayBuffer(object):
    def __init__(self, size, frame_history_len):
        ...
        self.reward   = None
        self.done     = None
        self.a_0 = [0, 0, 0, 0, 0, 0]  # NOOP\n",
        self.a_1 = [1, 0, 0, 0, 0, 0]  #Up\n",
        self.a_2 = [0, 0, 1, 0, 0, 0] # Down\n",
        self.a_3 = [0, 1, 0, 0, 0, 0] # Left\n"
        self.a_4 = [0, 1, 0, 0, 1, 0] # Left + A\n",
        self.a_5 = [0, 1, 0, 0, 0, 1]  # Left + B\n",
        self.a_6 = [0, 1, 0, 0, 1, 1]  # Left + A + B\n",
        self.a_7 = [0, 0, 0, 1, 0, 0] # Right\n",
        self.a_8 = [0, 0, 0, 1, 1, 0] # Right + A\n",
        self.a_9 = [0, 0, 0, 1, 0, 1]  # Right + A + B\n",
        self.a_10 = [0, 0, 0, 1, 1, 1]  #Right + A + B\n",
        self.a_11 = [0, 0, 0, 0, 1, 0]
        self.a_12 = [0, 0, 0, 0, 0, 1]
        self.a_13 = [0, 0, 0, 0, 1, 1]
            
    def encode_action_rand(self):
    ...
    def store_effect(self, idx, action, reward, done):
        ...
        """
        self.action[idx] = self.decode_action( action)
